...
void main() {
  ...
  test('Should emit requiredFieldError if email is invalid', () {
  ...
  test('Should emit requiredFieldError if password is invalid', () {
    mockValidation(value: ValidationError.requiredField);
  ...
  test('Should emit password error if validation success', () {
    sut.passwordErrorStream
  ...
  test('Should change page on sucess', () async {
    ...
    sut.navigationToStream.listen(expectAsync1((page) =>
        expect(page, '/surveys')));
